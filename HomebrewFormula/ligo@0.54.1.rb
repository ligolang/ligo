class LigoAT0541 < Formula
  ...
  url "https://gitlab.com/ligolang/ligo.git", tag: "0.54.1", revision: "4fc28fce66405b0edbd9e1f536a8bd6bd8bacee7"

  bottle do
    root_url "https://gitlab.com/ligolang/ligo/-/jobs/3245121952/artifacts/raw/ligo"
  end
