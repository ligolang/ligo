class LigoAT0490 < Formula
  ...
  url "https://gitlab.com/ligolang/ligo.git", tag: "0.49.0", revision: "d2a2e28af2e0d0bfaac16b585ef92def5cdf57a7"

  bottle do
    root_url "https://gitlab.com/ligolang/ligo/-/jobs/2896100663/artifacts/raw/ligo"
  end
