...
for SUBCOMMAND in "test" "measure-contract" "compile-contract" "compile-parameter" "compile-storage" "compile-expression" "transpile-contract" "transpile-expression" "interpret" "dry-run" "run-function" "evaluate-value" "changelog" "print-graph" "print-cst" "print-ast" "print-ast-sugar" "print-ast-core" "print-ast-typed" "print-ast-combined" "print-mini-c" "list-declarations" "preprocess" "pretty-print" "get-scope"; do
