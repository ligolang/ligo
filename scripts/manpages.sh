...
for SUBCOMMAND in "run test" "info measure-contract" "compile contract" "compile parameter" "compile storage" "compile expression" "transpile contract" "transpile expression" "run interpret" "run dry-run" "run evaluate-call" "run evaluate-expr" "changelog" "print dependency-graph" "print cst" "print ast-imperative" "print ast-sugar" "print ast-core" "print ast-typed" "print ast-combined" "print mini-c" "info list-declarations" "print preprocessed" "print pretty" "info get-scope"; do
