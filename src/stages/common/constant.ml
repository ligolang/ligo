...
let custom_length_name                     = "custom_length"
let custom_add_name                        = "custom_add"
...
let v_custom_length        : type_variable = Var.of_input_var custom_length_name
let v_custom_add          : type_variable = Var.of_input_var custom_add_name
