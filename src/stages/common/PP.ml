...
let option_ast_inline ppf ast_inline =
  if ast_inline then
    fprintf ppf "[@@ast_inline]"
  else
    fprintf ppf ""

let e_attributes ppf { inline ; no_mutation ; view ; public ; hidden ; ast_inline } =
