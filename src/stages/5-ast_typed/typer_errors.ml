module Ast_typed_self_reference = struct
  module Ast = Ast
  module PP = PP
...
type typer_error = [
  ...
  | `Typer_unbound_constructor of Ast_typed_self_reference.Environment.t * Ast_core.label * Location.t
  ...
  | `Typer_fvs_in_create_contract_lambda of Ast_core.expression * Ast_typed_self_reference.expression_variable
  | `Typer_create_contract_lambda of Ast_core.constant' * Ast_core.expression
  | `Typer_should_be_a_function_type of Ast_typed_self_reference.type_expression * Ast_core.expression
  | `Typer_bad_record_access of Ast_core.label * Ast_core.expression * Ast_typed_self_reference.type_expression * Location.t
  | `Typer_expression_tracer of Ast_core.expression * typer_error
  | `Typer_record_access_tracer of Ast_typed_self_reference.expression * typer_error
  | `Typer_assert_equal of Location.t * Ast_typed_self_reference.type_expression * Ast_typed_self_reference.type_expression
  | `Typer_corner_case of string
  | `Typer_bad_collect_loop of Ast_typed_self_reference.type_expression * Location.t
  | `Typer_declaration_order_record of Location.t
  | `Typer_too_small_record of Location.t
  | `Typer_expected_record of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_variant of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_wrong_param_number of Location.t * string * int * Ast_typed_self_reference.type_expression list
  | `Typer_expected_function of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_pair of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_list of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_set of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_map of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_big_map of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_option of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_nat of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_bytes of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_key of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_signature of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_contract of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_string of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_key_hash of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_expected_mutez of Location.t * Ast_typed_self_reference.type_expression
  ...
  | `Typer_wrong_size of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_wrong_neg of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_wrong_not of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_typeclass_error of Location.t * Ast_typed_self_reference.type_expression list list * Ast_typed_self_reference.type_expression list
  | `Typer_converter of Ast_typed_self_reference.type_expression
  | `Typer_uncomparable_types of Location.t * Ast_typed_self_reference.type_expression * Ast_typed_self_reference.type_expression
  | `Typer_comparator_composed of Location.t * Ast_typed_self_reference.type_expression
  | `Typer_constant_decl_tracer of Ast_core.expression_variable * Ast_core.expression * Ast_typed_self_reference.type_expression option * typer_error
  ...
  | `Typer_different_types of Ast_typed_self_reference.type_expression * Ast_typed_self_reference.type_expression
...
let unbound_constructor (e:Ast_typed_self_reference.Environment.t) (c:Ast_core.label) (loc:Location.t) = `Typer_unbound_constructor (e,c,loc)
...
let fvs_in_create_contract_lambda (e:Ast_core.expression) (fvar:Ast_typed_self_reference.expression_variable) = `Typer_fvs_in_create_contract_lambda (e,fvar)
let create_contract_lambda (cst : Ast_core.constant') (e : Ast_core.expression) = `Typer_create_contract_lambda (cst,e)
let type_error_approximate ~(actual: Ast_typed_self_reference.type_expression) ~(expression:Ast_core.expression) =
  `Typer_should_be_a_function_type (actual,expression)
let bad_record_access (field:Ast_core.label) (ae:Ast_core.expression) (t:Ast_typed_self_reference.type_expression) (loc:Location.t) =
  `Typer_bad_record_access (field,ae,t,loc)
let expression_tracer ae err = `Typer_expression_tracer (ae,err)
let record_access_tracer (e:Ast_typed_self_reference.expression) (err:typer_error) = `Typer_record_access_tracer (e,err)
let assert_equal (loc:Location.t) (expected:Ast_typed_self_reference.type_expression) (actual:Ast_typed_self_reference.type_expression) = `Typer_assert_equal (loc,expected,actual)
let corner_case desc = `Typer_corner_case desc
let bad_collect_loop (t:Ast_typed_self_reference.type_expression) (loc:Location.t) = `Typer_bad_collect_loop (t,loc)
...
let expected_record (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_record (loc,t)
let expected_variant (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_variant (loc,t)
let wrong_param_number (loc:Location.t) (name:string) (expected:int) (actual:Ast_typed_self_reference.type_expression list) =
...
let expected_option (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_option (loc,t)
let expected_nat (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_nat (loc,t)
let expected_bytes (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_bytes (loc,t)
...
let expected_op_list (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_op_list (loc,t)
let expected_int (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_int (loc,t)
let expected_bool (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_expected_bool (loc,t)
let expected_ascription (t:Ast_core.expression) = `Typer_expected_ascription t
let not_matching (loc:Location.t) (t1:Ast_typed_self_reference.type_expression) (t2:Ast_typed_self_reference.type_expression) = `Typer_not_matching (loc,t1,t2)
let not_annotated (loc: Location.t) = `Typer_not_annotated loc
let bad_subtraction (loc:Location.t) = `Typer_bad_substraction loc
let wrong_size (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_wrong_size (loc,t)
let wrong_neg (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_wrong_neg (loc,t)
let wrong_not (loc:Location.t) (t:Ast_typed_self_reference.type_expression) = `Typer_wrong_not (loc,t)
let typeclass_error (loc:Location.t) (exps:Ast_typed_self_reference.type_expression list list) (acts:Ast_typed_self_reference.type_expression list) =
  `Typer_typeclass_error (loc,exps,acts)
let wrong_converter (t:Ast_typed_self_reference.type_expression) = `Typer_converter t
let uncomparable_types (loc:Location.t) (a:Ast_typed_self_reference.type_expression) (b:Ast_typed_self_reference.type_expression) =
  `Typer_uncomparable_types (loc,a,b)
let comparator_composed (loc:Location.t) (a:Ast_typed_self_reference.type_expression) = `Typer_comparator_composed (loc,a)
let unrecognized_type_constant (e:Ast_core.type_expression) = `Typer_unrecognized_type_constant e

(* new typer errors *)
let constant_declaration_tracer (name: Ast_core.expression_variable) (ae:Ast_core.expression) (expected: Ast_typed_self_reference.type_expression option) (err:typer_error) =
  ...
  | Human_readable | Dev -> (
    ...
    | `Typer_missing_funarg_annotation v ->
      Format.fprintf f
        "@[<hv>%a@.Missing a type annotation for argument \"%a\".@]"
          ...
          Ast_typed_self_reference.PP.expression_variable v
    ...
    | `Typer_unbound_type_variable (_env,tv,loc) ->
      Format.fprintf f
        ...
        Snippet.pp loc
        Ast_typed_self_reference.PP.type_variable tv
    ...
    | `Typer_match_error (expected,actual,loc) ->
      Format.fprintf f
        ...
        Ast_typed_self_reference.PP.type_expression actual
    ...
    | `Typer_fvs_in_create_contract_lambda (e,fvar) ->
      Format.fprintf f
        ...
        Ast_typed_self_reference.PP.expression_variable fvar
  ...
  * mutez/tez - mutez/tez = mutez.@]"
    ...
    | `Typer_different_types (a, b) ->
      Format.fprintf f
        ...
        Ast_typed_self_reference.PP.type_expression b
        Ast_typed_self_reference.PP.type_expression a
    | `Typer_assert_equal (loc, expected,actual) ->
      Format.fprintf f
        "@[<hv>%a@.Invalid type(s).@.Expected: \"%a\", but got: \"%a\". @]"
        Snippet.pp loc
        Ast_typed_self_reference.PP.type_expression expected
        Ast_typed_self_reference.PP.type_expression actual
    ...
    | `Typer_expected_function (loc,e) ->
      Format.fprintf f
        ...
        Snippet.pp loc
        Ast_typed_self_reference.PP.type_expression e
    ...
    | `Typer_not_matching (loc,t1,t2) ->
      Format.fprintf f
        ...
        Snippet.pp loc
        Ast_typed_self_reference.PP.type_expression t1
        Ast_typed_self_reference.PP.type_expression t2
    | `Typer_uncomparable_types (loc,a,b) ->
      Format.fprintf f
    ...
    | `Typer_typeclass_error (loc,exps,acts) ->
      ...
      let printl printer ppf args =
        ...
        Snippet.pp loc
        (list_sep (printl Ast_typed_self_reference.PP.type_expression) (const " or ")) exps
        (list_sep Ast_typed_self_reference.PP.type_expression (const ", ")) acts
    ...
    | `Typer_constant_tag_number_of_arguments (loc, opa, _opb, lena, lenb) ->
      Format.fprintf f
        ...
        (Format.asprintf "%a" Ast_typed_self_reference.PP.constant_tag opa) lena lenb loc
    | `Typer_typeclass_not_a_rectangular_matrix ->
...
let rec error_jsonformat : typer_error -> Yojson.Safe.t = fun a ->
  ...
  | `Typer_unbound_type_variable (env,tv,loc) ->
    ...
    let loc = Format.asprintf "%a" Location.pp loc in
    let value = Format.asprintf "%a" Ast_typed_self_reference.PP.type_variable tv in
    let env = Format.asprintf "%a" Ast_typed_self_reference.Environment.PP.environment env in
    let content = `Assoc [
      ("message", message);
      ("location", `String loc);
      ("value", `String value);
  ...
  | `Typer_unbound_variable (env,v,loc) ->
    let message = `String "unbound type variable" in
    let loc = Format.asprintf "%a" Location.pp loc in
    let value = Format.asprintf "%a" Ast_typed_self_reference.PP.expression_variable v in
    let env = Format.asprintf "%a" Ast_typed_self_reference.Environment.PP.environment env in
    let content = `Assoc [
      ("message", message);
      ("location", `String loc);
  ...
  | `Typer_constant_declaration_tracer (name,ae,Some t,err) ->
    ...
    let expected = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression t) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
      ("name", name);
  ...
  | `Typer_match_error (expected,actual,loc) ->
    ...
    let actual = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression actual) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
      ("actual", actual);
  ...
  | `Typer_fvs_in_create_contract_lambda (e,fvar) ->
    ...
    let variable = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.expression_variable fvar) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
  ...
  | `Typer_bad_record_access (field,ae,t,loc) ->
    ...
    let value = `String (Format.asprintf "%a" Ast_core.PP.expression ae) in
    let value_type = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression t) in
    let loc = `String (Format.asprintf "%a" Location.pp loc) in
    let content = `Assoc [
  ...
  | `Typer_record_access_tracer (e,err) ->
    ...
    let expression = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.expression e) in
    let loc = `String (Format.asprintf "%a" Location.pp e.location) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
  ...
  | `Typer_assert_equal (loc,expected,actual) ->
    ...
    let expected = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression expected) in
    let actual = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression actual) in
    let content = `Assoc [
      ("location", Location.to_yojson loc);
      ("message" , message);
  ...
  | `Typer_bad_collect_loop (t,loc) ->
    ...
    let actual = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression t) in
    let loc = `String (Format.asprintf "%a" Location.pp loc) in
    let content = `Assoc [
      ("message", message);
      ("location", loc);
  ...
  | `Typer_expected_string (loc,t) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value", Ast_typed_self_reference.Yojson.type_expression t);
    ] in
    json_error ~stage ~content
  | `Typer_expected_key_hash (loc,t) ->
  ...
  | `Typer_expected_function (loc,e) ->
    ...
    let value = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression e) in
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value", value);
  ...
  | `Typer_expected_pair (loc,e) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value", Ast_typed_self_reference.Yojson.type_expression e);
    ] in
    json_error ~stage ~content
  | `Typer_expected_list (loc,e) ->
  ...
  | `Typer_not_matching (loc,t1,t2) ->
    ...
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("value_1", Ast_typed_self_reference.Yojson.type_expression t1);
      ("value_2", Ast_typed_self_reference.Yojson.type_expression t2);
    ] in
    json_error ~stage ~content
  ...
  | `Typer_typeclass_error (loc,exps,acts) ->
    ...
    let expected = `String (Format.asprintf "%a" (list_sep (printl Ast_typed_self_reference.PP.type_expression) (const " or ")) exps) in
    let actual = `String (Format.asprintf "%a" (list_sep Ast_typed_self_reference.PP.type_expression (const " or ")) acts) in
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("expected", expected);
  ...
  | `Typer_uncomparable_types (loc,a,b) ->
    ...
    let t1 = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression a) in
    let t2 = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression b) in
    let content = `Assoc [
      ("message", message);
      ("location", Location.to_yojson loc);
      ("type_1", t1);
  ...
  | `Typer_constant_decl_tracer (name,ae,expected,err) ->
    ...
    let expected = `String (match expected with
      ...
      | Some expected -> Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression expected) in
    let content = `Assoc [
      ("message", message) ;
      ("name", name) ;
      ("location", loc) ;
  ...
  | `Typer_different_types (a,b) ->
    ...
    let a = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression a) in
    let b = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.type_expression b) in
    let content = `Assoc [
      ("message", message) ;
      ("a", a) ;
      ("b", b) ;
  ...
  | `Typer_constant_tag_number_of_arguments (loc, opa, opb, lena, lenb) ->
    ...
    let op = `String (Format.asprintf "%a" Ast_typed_self_reference.PP.constant_tag opa) in
