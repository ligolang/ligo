...
let e_none ~loc =
  e_constructor ~loc { constructor = Label.of_string "None"; element = e_unit ~loc }
...
let e_bool ~loc b =
  let e_true_ctor ~loc =
    e_constructor ~loc { constructor = Label.of_string "True"; element = e_unit ~loc }
  in
  let e_false_ctor ~loc =
    e_constructor ~loc { constructor = Label.of_string "False"; element = e_unit ~loc }
  in
