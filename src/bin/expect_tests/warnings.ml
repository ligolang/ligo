...
[@@expect.uncaught_exn {|
  ...
  Called from Ligo_compile__Of_mini_c.compile_expression in file "src/main/compile/of_mini_c.ml", line 176, characters 4-81
  Called from Build.build_expression in file "src/main/build/build.ml", line 645, characters 9-77
  ...
  Called from Cli_expect_tests__Warnings.(fun) in file "src/bin/expect_tests/warnings.ml", line 39, characters 2-143
