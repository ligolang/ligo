...
Variable "create_contract" not found. |}];
  ...
  [%expect
    ...
    Not all free variables could be inlined in Tezos.create_contract usage: gen#447. |}];
  ...
  [%expect
    ...
    Not all free variables could be inlined in Tezos.create_contract usage: foo#460. |}];
