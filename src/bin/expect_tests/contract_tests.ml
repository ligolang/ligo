...
let%expect_test _ =
  ...
  [%expect {|
    let get_balance#8 =
      fun _u#600 -> (({ DROP ; BALANCE })@(L(unit)))[@inline] in
    let get_amount#9 = fun _u#602 -> (({ DROP ; AMOUNT })@(L(unit)))[@inline] in
    let get_now#10 = fun _u#604 -> (({ DROP ; NOW })@(L(unit)))[@inline] in
    let get_sender#11 = fun _u#606 -> (({ DROP ; SENDER })@(L(unit)))[@inline] in
    let sender#12 = (get_sender#11)@(L(unit))[@inline] in
    let get_source#13 = fun _u#609 -> (({ DROP ; SOURCE })@(L(unit)))[@inline] in
    let get_level#14 = fun _u#611 -> (({ DROP ; LEVEL })@(L(unit)))[@inline] in
    let get_self_address#15 = fun _u#613 -> (SELF_ADDRESS())[@inline] in
    let get_chain_id#16 =
      fun _u#615 -> (({ DROP ; CHAIN_ID })@(L(unit)))[@inline] in
    let get_total_voting_power#17 =
      fun _u#617 -> (({ DROP ; TOTAL_VOTING_POWER })@(L(unit)))[@inline] in
    let get_min_block_time#18 =
      fun _u#619 -> (({ DROP ; MIN_BLOCK_TIME })@(L(unit)))[@inline] in
    let voting_power#19 = fun kh#621 -> (({ VOTING_POWER })@(kh#621))[@inline] in
    let implicit_account#21 =
      fun kh#625 -> (IMPLICIT_ACCOUNT(kh#625))[@inline] in
    let pairing_check#25 = fun l#633 -> (({ PAIRING_CHECK })@(l#633))[@inline] in
    let set_delegate#27 = fun o#637 -> (SET_DELEGATE(o#637))[@inline] in
    let open_chest#33 =
      fun ck#653 ->
      (fun c#654 -> (fun n#655 -> (OPEN_CHEST(ck#653 , c#654 , n#655))))[@inline] in
    let xor#36 = fun l#664 -> (fun r#665 -> (XOR(l#664 , r#665)))[@inline] in
    let shift_left#37 =
      fun l#667 -> (fun r#668 -> (LSL(l#667 , r#668)))[@inline] in
    let shift_right#38 =
      fun l#670 -> (fun r#671 -> (LSR(l#670 , r#671)))[@inline] in
    let length#79 = fun b#801 -> (({ SIZE })@(b#801))[@inline] in
    let concat#80 =
      fun b1#803 ->
      (fun b2#804 -> (({ UNPAIR ; CONCAT })@(PAIR(b1#803 , b2#804))))[@inline] in
    let sub#81 =
      fun s#806 ->
      (fun l#807 ->
       (fun b#808 ->
        (({ UNPAIR ;
           UNPAIR ;
           SLICE ;
           IF_NONE { PUSH string "SLICE" ; FAILWITH } {} })@(PAIR(PAIR(s#806 ,
                                                                       l#807) ,
                                                                  b#808)))))[@inline] in
    let length#86 = fun b#819 -> (({ SIZE })@(b#819))[@inline] in
    let concat#87 =
      fun b1#821 ->
      (fun b2#822 -> (({ UNPAIR ; CONCAT })@(PAIR(b1#821 , b2#822))))[@inline] in
    let sub#88 =
      fun s#824 ->
      (fun l#825 ->
       (fun b#826 ->
        (({ UNPAIR ;
           UNPAIR ;
           SLICE ;
           IF_NONE { PUSH string "SLICE" ; FAILWITH } {} })@(PAIR(PAIR(s#824 ,
                                                                       l#825) ,
                                                                  b#826)))))[@inline] in
    let blake2b#89 = fun b#828 -> (({ BLAKE2B })@(b#828))[@inline] in
    let sha256#90 = fun b#830 -> (({ SHA256 })@(b#830))[@inline] in
    let sha512#91 = fun b#832 -> (({ SHA512 })@(b#832))[@inline] in
    let sha3#92 = fun b#834 -> (({ SHA3 })@(b#834))[@inline] in
    let keccak#93 = fun b#836 -> (({ KECCAK })@(b#836))[@inline] in
    let hash_key#94 = fun k#838 -> (({ HASH_KEY })@(k#838))[@inline] in
    let check#95 =
      fun k#840 ->
      (fun s#841 ->
       (fun b#842 ->
        (({ UNPAIR ; UNPAIR ; CHECK_SIGNATURE })@(PAIR(PAIR(k#840 , s#841) ,
                                                       b#842)))))[@inline] in
    let assert =
      fun b#844 ->
      (({ IF { UNIT } { PUSH string "failed assertion" ; FAILWITH } })@(b#844))[@inline] in
    let abs = fun i#850 -> (({ ABS })@(i#850))[@inline] in
    let is_nat = fun i#852 -> (({ ISNAT })@(i#852))[@inline] in
    ...
    let assert_with_error =
      fun b#860 ->
      (fun s#861 ->
       (({ UNPAIR ; IF { DROP ; UNIT } { FAILWITH } })@(PAIR(b#860 , s#861))))[@inline] in
    let poly_stub_39 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_38 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_37 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_36 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_35 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_34 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_33 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_32 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_31 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_30 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_29 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_28 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_27 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_26 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_25 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_24 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_23 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_22 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_21 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_20 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_19 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_18 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_17 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_16 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_15 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_14 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_13 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_12 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_11 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_10 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_9 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_8 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_7 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_6 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_5 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_4 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_3 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_2 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let poly_stub_1 = fun x#872 -> (({ FAILWITH })@(x#872))[@inline] in
    let get_total_voting_power#100 =
      fun _u#881 -> ((poly_stub_39)@(L(unit)))[@inline] in
    let set_source#103 = fun _a#887 -> ((poly_stub_38)@(L(unit)))[@inline] in
    let get_storage_of_address#104 =
      fun _a#889 -> ((poly_stub_37)@(L(unit)))[@inline] in
    let get_balance#105 = fun _a#891 -> ((poly_stub_36)@(L(unit)))[@inline] in
    let print#106 = fun _v#893 -> ((poly_stub_35)@(L(unit)))[@inline] in
    let eprint#107 = fun _v#895 -> ((poly_stub_34)@(L(unit)))[@inline] in
    let get_voting_power#108 =
      fun _kh#897 -> ((poly_stub_33)@(L(unit)))[@inline] in
    let nth_bootstrap_contract#109 =
      fun _i#899 -> ((poly_stub_32)@(L(unit)))[@inline] in
    let nth_bootstrap_account#110 =
      fun _i#901 -> ((poly_stub_31)@(L(unit)))[@inline] in
    let get_bootstrap_account#111 =
      fun _n#903 -> ((poly_stub_30)@(L(unit)))[@inline] in
    let last_originations#113 =
      fun _u#907 -> ((poly_stub_29)@(L(unit)))[@inline] in
    let new_account#115 = fun _u#911 -> ((poly_stub_28)@(L(unit)))[@inline] in
    let bake_until_n_cycle_end#117 =
      fun _n#915 -> ((poly_stub_27)@(L(unit)))[@inline] in
    let register_delegate#119 =
      fun _kh#919 -> ((poly_stub_26)@(L(unit)))[@inline] in
    let register_constant#120 =
      fun _m#921 -> ((poly_stub_25)@(L(unit)))[@inline] in
    let constant_to_michelson_program#122 =
      fun _s#925 -> ((poly_stub_24)@(L(unit)))[@inline] in
    let restore_context#123 =
      fun _u#927 -> ((poly_stub_23)@(L(unit)))[@inline] in
    let save_context#124 = fun _u#929 -> ((poly_stub_22)@(L(unit)))[@inline] in
    let drop_context#125 = fun _u#931 -> ((poly_stub_21)@(L(unit)))[@inline] in
    let set_baker_policy#128 =
      fun _bp#937 -> ((poly_stub_20)@(L(unit)))[@inline] in
    let set_baker#129 = fun _a#939 -> ((poly_stub_19)@(L(unit)))[@inline] in
    let size#130 = fun _c#941 -> ((poly_stub_18)@(L(unit)))[@inline] in
    let read_contract_from_file#132 =
      fun _fn#945 -> ((poly_stub_17)@(L(unit)))[@inline] in
    let chr#133 = fun _n#947 -> ((poly_stub_16)@(L(unit)))[@inline] in
    let nl#134 = L("NEWLINE")[@inline] in
    let println#135 = fun _v#950 -> ((poly_stub_15)@(L(unit)))[@inline] in
    let transfer#136 =
      fun _a#952 -> (fun _s#953 -> (fun _t#954 -> ((poly_stub_14)@(L(unit)))))[@inline] in
    let transfer_exn#137 =
      fun _a#956 -> (fun _s#957 -> (fun _t#958 -> ((poly_stub_13)@(L(unit)))))[@inline] in
    let reset_state#139 =
      fun _n#962 -> (fun _l#963 -> ((poly_stub_12)@(L(unit))))[@inline] in
    let reset_state_at#140 =
      fun _t#965 -> (fun _n#966 -> (fun _l#967 -> ((poly_stub_11)@(L(unit)))))[@inline] in
    let save_mutation#143 =
      fun _s#976 -> (fun _m#977 -> ((poly_stub_10)@(L(unit))))[@inline] in
    let sign#146 =
      fun _sk#985 -> (fun _d#986 -> ((poly_stub_9)@(L(unit))))[@inline] in
    let add_account#147 =
      fun _s#988 -> (fun _k#989 -> ((poly_stub_8)@(L(unit))))[@inline] in
    let baker_account#148 =
      fun _p#991 -> (fun _o#992 -> ((poly_stub_7)@(L(unit))))[@inline] in
    let create_chest#150 =
      fun _b#997 -> (fun _n#998 -> ((poly_stub_6)@(L(unit))))[@inline] in
    let create_chest_key#151 =
      fun _c#1000 -> (fun _n#1001 -> ((poly_stub_5)@(L(unit))))[@inline] in
    let michelson_equal#154 =
      fun _m1#1011 -> (fun _m2#1012 -> ((poly_stub_4)@(L(unit))))[@inline] in
    let originate_contract#156 =
      fun _c#1017 -> (fun _s#1018 -> (fun _t#1019 -> ((poly_stub_3)@(L(unit)))))[@inline] in
    let compile_contract_from_file#158 =
      fun _fn#1025 -> (fun _e#1026 -> (fun _v#1027 -> ((poly_stub_2)@(L(unit)))))[@inline] in
    let originate_from_file#159 =
      fun _fn#1029 ->
      (fun _e#1030 ->
       (fun _v#1031 ->
        (fun _s#1032 -> (fun _t#1033 -> ((poly_stub_1)@(L(unit)))))))[@inline] in
    let x#160 = L(54) in let y#161 = x#160 in L(unit) |}]
