...
let%expect_test _ =
  ...
  [%expect{|
let #../../test/contracts/build/A.mligo#toto#363 = L(1) in
let #../../test/contracts/build/B.mligo#titi#637 =
  ADD(#../../test/contracts/build/A.mligo#toto#363 , L(42)) in
let #../../test/contracts/build/C.mligo#tata#1457 =
  ADD(#../../test/contracts/build/A.mligo#toto#363 ,
      #../../test/contracts/build/B.mligo#titi#637) in
let x =
  ADD(ADD(L(3) , #../../test/contracts/build/A.mligo#toto#363) ,
      #../../test/contracts/build/B.mligo#titi#637) in
let toto = ADD(L(10) , #../../test/contracts/build/A.mligo#toto#363) in
L(unit) |}]
