...
let%expect_test _ =
  ...
  [%expect{|
let #../../test/contracts/build/A.mligo#toto#340 = L(1) in
let #../../test/contracts/build/B.mligo#titi#591 =
  ADD(#../../test/contracts/build/A.mligo#toto#340 , L(42)) in
let #../../test/contracts/build/C.mligo#tata#1342 =
  ADD(#../../test/contracts/build/A.mligo#toto#340 ,
      #../../test/contracts/build/B.mligo#titi#591) in
let x =
  ADD(ADD(L(3) , #../../test/contracts/build/A.mligo#toto#340) ,
      #../../test/contracts/build/B.mligo#titi#591) in
let toto = ADD(L(10) , #../../test/contracts/build/A.mligo#toto#340) in
L(unit) |}]
