...
let%expect_test _ =
  ...
  [%expect{|
let #../../test/contracts/build/A.mligo#toto#362 = L(1) in
let #../../test/contracts/build/B.mligo#titi#635 =
  ADD(#../../test/contracts/build/A.mligo#toto#362 , L(42)) in
let #../../test/contracts/build/C.mligo#tata#1452 =
  ADD(#../../test/contracts/build/A.mligo#toto#362 ,
      #../../test/contracts/build/B.mligo#titi#635) in
let x =
  ADD(ADD(L(3) , #../../test/contracts/build/A.mligo#toto#362) ,
      #../../test/contracts/build/B.mligo#titi#635) in
let toto = ADD(L(10) , #../../test/contracts/build/A.mligo#toto#362) in
L(unit) |}]
