...
let%expect_test _ =
  begin
    run_ligo_bad ["compile"; "contract";
                  "../../test/preprocessor/dangling_elif.ligo"];
    [%expect {test|
...
|test}];
    ...
    run_ligo_bad ["compile"; "contract";
                  "../../test/preprocessor/dangling_else.ligo"];
    [%expect {test|
...
|test}];
    ...
    run_ligo_bad ["compile"; "contract";
                  "../../test/preprocessor/dangling_endif.ligo"];
    [%expect {test|
...
|test}];
    ...
    run_ligo_bad ["compile"; "contract";                  "../../test/preprocessor/invalid_character_in_string.ligo"];
    [%expect {test|
...
|test}];
    ...
    run_ligo_bad ["compile"; "contract";                  "../../test/preprocessor/unexpected_argument.ligo"];
    [%expect {test|
...
|test}];
    ...
    run_ligo_bad ["compile"; "contract";                  "../../test/preprocessor/unterminated_comment.ligo"];
    [%expect {test|
...
|test}];
    ...
    run_ligo_bad ["compile"; "contract";                  "../../test/preprocessor/unterminated_string.ligo"];
    [%expect {test|
