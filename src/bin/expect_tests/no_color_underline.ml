...
let%expect_test _ =
  run_ligo_bad
    [ "compile"; "contract"; gs "one_line_error.mligo";  "--no-color" ];
  [%expect{xxx|
...
let%expect_test _ =
  run_ligo_bad
    [ "compile"; "contract"; gs "two_lines_error.mligo";  "--no-color" ];
  [%expect{xxx|
...
let%expect_test _ =
  run_ligo_bad
    [ "compile"; "contract"; gs "several_lines_error.mligo";  "--no-color" ];
  [%expect{xxx|
