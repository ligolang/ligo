...
[@@expect.uncaught_exn {|
  ...
  Called from Cli_expect_tests__Top_level_binding_pattern_cameligo.(fun) in file "src/bin/expect_tests/top_level_binding_pattern_cameligo.ml", lines 863-869, characters 2-5
...
[@@expect.uncaught_exn {|
  ...
  Re-raised at Cli.run in file "src/bin/cli.ml", line 3760, characters 21-30
  Called from Cli_expect_tests__Cli_expect.run_ligo_bad in file "src/bin/expect_tests/cli_expect.ml", line 46, characters 18-31
  Called from Cli_expect_tests__Top_level_binding_pattern_cameligo.(fun) in file "src/bin/expect_tests/top_level_binding_pattern_cameligo.ml", lines 958-964, characters 2-5
  Called from Ppx_expect_runtime__Test_block.Configured.dump_backtrace in file "runtime/test_block.ml", line 142, characters 10-28
  |}]
