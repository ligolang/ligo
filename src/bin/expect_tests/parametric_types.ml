...
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.mligo") ; "t1" ] ;
  [%expect{|
    ( 1 , "one" ) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.mligo") ; "t2" ] ;
  [%expect{|
    CONS(2 , CONS(3 , CONS(4 , LIST_EMPTY()))) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.mligo") ; "t3" ] ;
  [%expect{|
    ( +1 , 1 ) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.mligo") ; "t4" ] ;
  [%expect{|
    CONS(1 , CONS(2 , CONS(3 , LIST_EMPTY()))) |}]

let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.religo") ; "t1" ] ;
  [%expect{|
    ( 1 , "one" ) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.religo") ; "t2" ] ;
  [%expect{|
    CONS(2 , CONS(3 , CONS(4 , LIST_EMPTY()))) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.religo") ; "t3" ] ;
  [%expect{|
    ( +1 , 1 ) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.religo") ; "t4" ] ;
  [%expect{|
    CONS(1 , CONS(2 , CONS(3 , LIST_EMPTY()))) |}]
...
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.ligo") ; "t1" ] ;
  [%expect{|
    ( 1 , "one" ) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.ligo") ; "t2" ] ;
  [%expect{|
    CONS(2 , CONS(3 , CONS(4 , LIST_EMPTY()))) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.ligo") ; "t3" ] ;
  [%expect{|
    ( +1 , 1 ) |}]
let%expect_test _ =
  run_ligo_good [ "interpret" ; "--init-file="^(test "parametric_types.ligo") ; "t4" ] ;
  [%expect{|
    CONS(1 , CONS(2 , CONS(3 , LIST_EMPTY()))) |}]
