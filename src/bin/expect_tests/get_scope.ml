...
(a#0 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/lambda_letin.mligo", line 1, characters 4-5
(b#6 -> b) |resolved: int | in file "../../test/contracts/get_scope_tests/lambda_letin.mligo", line 3, characters 4-5
(f#5 -> f) |core: int -> int -> int | in file "../../test/contracts/get_scope_tests/lambda_letin.mligo", line 4, characters 6-7
(g#3 -> g) |resolved: int | in file "../../test/contracts/get_scope_tests/lambda_letin.mligo", line 5, characters 8-9
...
Variable definitions:
(a#0 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/letin.mligo", line 1, characters 4-5
(b#5 -> b) |resolved: int | in file "../../test/contracts/get_scope_tests/letin.mligo", line 3, characters 4-5
(c#1 -> c) |resolved: int | in file "../../test/contracts/get_scope_tests/letin.mligo", line 4, characters 6-7
...
Variable definitions:
(a#0 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/lambda.mligo", line 1, characters 4-5
(b#4 -> b) |resolved: int | in file "../../test/contracts/get_scope_tests/lambda.mligo", line 3, characters 4-5
...
Type definitions: |} ] ;
  ...
  [%expect{|
    ...
    Variable definitions:
    (a#1 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 3, characters 4-5
    (b#5 -> b) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 5, characters 4-5
    (c#2 -> c) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 6, characters 13-14
    (c#6 -> c) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 13, characters 8-9
    (c#9 -> c) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 10, characters 4-5
    (d#10 -> d) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 18, characters 13-14
    (d#12 -> d) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 17, characters 4-5
    (hd#7 -> hd) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 15, characters 4-6
    (s#11 -> s) |resolved: int | in file "../../test/contracts/get_scope_tests/match.mligo", line 19, characters 4-12
    (tl#8 -> tl) |resolved: list (int) | in file "../../test/contracts/get_scope_tests/match.mligo", line 15, characters 4-6
  ...
  [%expect{|
    ...
    Variable definitions:
    (a#0 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/shadowing.mligo", line 1, characters 4-5
    (a#3 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/shadowing.mligo", line 7, characters 8-9
    (b#5 -> b) |resolved: int | in file "../../test/contracts/get_scope_tests/shadowing.mligo", line 3, characters 4-5
  ...
  [%expect{|
    ...
    Variable definitions:
    (a#1 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/records.mligo", line 3, characters 4-5
    (b#4 -> b) |resolved: myrec | in file "../../test/contracts/get_scope_tests/records.mligo", line 6, characters 4-5
    (e#6 -> e) |resolved: myrec | in file "../../test/contracts/get_scope_tests/records.mligo", line 15, characters 4-5
    (g#5 -> g) |resolved: int | in file "../../test/contracts/get_scope_tests/records.mligo", line 16, characters 19-20
  ...
  [%expect{|
    ...
    Variable definitions:
    (a#0 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/constant.mligo", line 1, characters 4-5
    (b#4 -> b) |resolved: list (int) | in file "../../test/contracts/get_scope_tests/constant.mligo", line 3, characters 4-5
  ...
  [%expect{|
    ...
    Variable definitions:
    (a#5 -> a) |resolved: int | in file "../../test/contracts/get_scope_tests/application.mligo", line 1, characters 4-5
    (b#3 -> b) |resolved: int | in file "../../test/contracts/get_scope_tests/application.mligo", line 3, characters 7-8
    (c#4 -> c) |resolved: int | in file "../../test/contracts/get_scope_tests/application.mligo", line 3, characters 26-27
