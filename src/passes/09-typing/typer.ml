...
let untype_program =
  if use_new_typer
  then Typer_common.Untyper.untype_program
         Typer_new.untype_expression Typer_new.untype_type_expression
  else Typer_common.Untyper.untype_program
         Typer_old.untype_expression Typer_old.untype_type_expression
