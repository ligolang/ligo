...
type stacking_error = [
  ...
  | `Stacking_unsupported_primitive of Ligo_prim.Constant.constant' * Environment.Protocols.t
...
let error_ppformat : display_format:string display_format ->
  ...
  | Human_readable | Dev -> (
    ...
    | `Stacking_unsupported_primitive (c,p) ->
      Format.fprintf f "@[<hv>unsupported primitive %a in protocol %s@]" Ligo_prim.Constant.pp_constant' c (Environment.Protocols.variant_to_string p)
