...
let compile_exp_attributes : I.attributes -> O.known_attributes = fun attributes ->
  ...
  O.{inline; no_mutation; view; public; thunk; hidden}
...
let rec compile_expression : I.expression -> O.expression =
  ...
  match sugar.expression_content with
    ...
    | I.E_sequence {expr1; expr2} ->
      ...
      return @@ O.E_let_in {let_binder; rhs=expr1;let_result=expr2; attr = {inline=false; no_mutation=false; view = false ; public=true ; thunk = false ; hidden = false}}
    ...
    | I.E_tuple t ->
      ...
      return @@ O.E_record m
    | I.E_assign a -> let a = assign self a in return @@ O.E_assign a
