...
let compile_program ~raise : Ast_typed.expression -> Ast_typed.program -> Ast_aggregated.program =
  fun hole program ->
...
let compile_expression_in_context ~raise : Ast_typed.expression -> Ast_typed.program -> Ast_aggregated.expression =
  fun hole program ->
