...
let bad_http_storage : storage =
   { data = 42
   ; metadata = Big_map.literal
     [ ("", [%bytes "https://ipfs.iasfao/iadsfdsfaspfs/QmSBc8QuynU7bArUGtjwCRhZUbJyZQArrczKnqM7hZPtfV"])
     ]
   }
...
let good_http_storage : storage =
   { data = 42
   ; metadata = Big_map.literal
     [ ("", [%bytes "https://ipfs.io/ipfs/QmSBc8QuynU7bArUGtjwCRhZUbJyZQArrczKnqM7hZPtfV"])
     ]
   }
...
let good_http_sha256_storage : storage =
   { data = 42
   ; metadata = Big_map.literal
     [ ("", [%bytes "sha256://0x1f7c7fde391bc46a28cd98a77733fbe5927190dbe5493fe81244ee29dc624577/https:%2F%2Fipfs.io%2Fipfs%2FQmSBc8QuynU7bArUGtjwCRhZUbJyZQArrczKnqM7hZPtfV"])
     ]
   }
...
let bad_http_sha256_storage : storage =
   { data = 42
   ; metadata = Big_map.literal
     [ ("", [%bytes "sha256://0xff7c7fde391bc46a28cd98a77733fbe5927190dbe5493fe81244ee29dc624577/https:%2F%2Fipfs.io%2Fipfs%2FQmSBc8QuynU7bArUGtjwCRhZUbJyZQArrczKnqM7hZPtfV"])
     ]
   }

let hen_metadata = [%bytes {|{"authors":["@hicetnunc2000 <hicetnunc2000@protonmail.com>"],"description":"OBJKTs FA2 collectibles","homepage":"https://hicetnunc.xyz","interfaces":["TZIP-12"],"license":{"name":"MIT"},"name":"OBJKTs","repository":"https://github.com/hic2nc2000","version":"2.0.0"}|}]

let good_tezos_sha256_storage : storage =
   { data = 42
   ; metadata = Big_map.literal
     [ ("", [%bytes "sha256://0x1f7c7fde391bc46a28cd98a77733fbe5927190dbe5493fe81244ee29dc624577/tezos-storage:m"])
     ; ("m", hen_metadata)
     ]
   }
...
let bad_tezos_sha256_storage : storage =
   { data = 42
   ; metadata = Big_map.literal
     [ ("", [%bytes "sha256://0xff7c7fde391bc46a28cd98a77733fbe5927190dbe5493fe81244ee29dc624577/tezos-storage:m"])
     ; ("m", hen_metadata)
     ]
   }
