let test_fr =
  ...
  let value = Test.compile_value bls in
  let dec = (Test.decompile value : bls12_381_fr) in
...
let test_g1 =
  ...
  let value = Test.compile_value bls in
  let dec = (Test.decompile value : bls12_381_g1) in
  assert (Test.to_string dec = Test.to_string bls)
...
let test_g2 =
  ...
  let value = Test.compile_value bls in
  let dec = (Test.decompile value : bls12_381_g2) in
  assert (Test.to_string dec = Test.to_string bls)
