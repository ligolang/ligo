...
let transfer ~raise f s () =
  ...
  let new_storage =
    e_record_ez
      ...
      ; ( "allowances"
        , e_big_map [ e_record_ez [ "owner", from_; "spender", sender ], e_nat 90 ] )
      ; "total_supply", e_nat 300
      ]
  in
...
let transfer_not_e_allowance ~raise f s () =
  ...
  let storage =
    e_record_ez
      [ "tokens", e_big_map [ sender, e_nat 100; from_, e_nat 100; to_, e_nat 100 ]
      ; ( "allowances"
        , e_big_map [ e_record_ez [ "owner", from_; "spender", sender ], e_nat 0 ] )
      ; "total_supply", e_nat 300
      ]
  in
  let parameter =
...
let approve ~raise f s () =
  ...
  let storage =
    e_record_ez
      [ "tokens", e_big_map [ sender, e_nat 100; from_, e_nat 100; to_, e_nat 100 ]
      ; ( "allowances"
        , e_big_map [ e_record_ez [ "owner", sender; "spender", from_ ], e_nat 0 ] )
      ; "total_supply", e_nat 300
      ]
  in
  ...
  let new_storage =
    e_record_ez
      [ "tokens", e_big_map [ sender, e_nat 100; from_, e_nat 100; to_, e_nat 100 ]
      ; ( "allowances"
        , e_big_map [ e_record_ez [ "owner", sender; "spender", from_ ], e_nat 100 ] )
      ; "total_supply", e_nat 300
      ]
  in
  let input = e_pair parameter storage in
