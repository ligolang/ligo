...
let pascaligo_sdata =
  ...
  ; preproc =
      (fun ~raise s ->
        ...
        @@ fun ~raise ->
        Trace.from_result ~raise @@ Preprocessing.Pascaligo.preprocess_string [] s)
  ; parser =
      (fun ~raise buffer ->
...
let cameligo_sdata =
  ...
  ; preproc =
      (fun ~raise s ->
        trace ~raise preproc_tracer
        @@ fun ~raise ->
        Trace.from_result ~raise @@ Preprocessing.Cameligo.preprocess_string [] s)
  ; parser =
      (fun ~raise buffer ->
...
let reasonligo_sdata =
  ...
  ; preproc =
      (fun ~raise s ->
        trace ~raise preproc_tracer
        @@ fun ~raise ->
        Trace.from_result ~raise @@ Preprocessing.Reasonligo.preprocess_string [] s)
  ; parser =
      (fun ~raise buffer ->
