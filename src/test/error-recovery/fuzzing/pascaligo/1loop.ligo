 ...
 function for_collection_set ( var _ : unit ) : int * if is
 block {
 var acc : int := 0 ;
 var st : string := "to" ;
 ...
 var mymap : ( string , string ) := map [ " one" -> "," ; "two" -> " " ] ;
...
Replace ; with >= in line 20
Replace block with ) in line 36
Replace string with if in line 53
Delete in in line 70
Add } in line 71
Delete ( in line 81
Delete acc in line 83
Add remove in line 89
Delete int in line 102
Replace := with = in line 133
Delete map in line 143
Delete string in line 165
Add set in line 181
*)