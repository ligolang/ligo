let%expect_test "error_recovery_simple_jsligo" =
  ...
  [%expect
    ...
    PASS, 4, 95, 21, 179, 3, ./extra_eq_in_func_decl.jsligo
    ...
    PASS, 3, 75, 27, 55, 6, ./missing_comma_in_arguments.jsligo
    PASS, 4, 26, 12, 22, 2, ./missing_comma_in_list_pat.jsligo
    PASS, 4, 32, 24, 331, 1, ./missing_comma_in_record_decl.jsligo
    PASS, 5, 88, 40, 78, 8, ./missing_comma_in_tuple_pat.jsligo
    PASS, 13, 205, 1, 126, 0, ./missing_curly_bracketR_in_the_nested_namespace.jsligo
    ...
    PASS, 4, 95, 21, 179, 2, ./missing_name_of_argument.jsligo
    PASS, 16, 140, 12, 250, 2, ./missing_namespace_kw_in_namespace_decl.jsligo
    PASS, 2, 2, 2, 8, 0, ./missing_namespace_name.jsligo
    PASS, 16, 133, 1, 244, 1, ./missing_open_curly_bracket_in_namespace_decl.jsligo
    ...
    PASS, 1, 9, 9, 97, 0, ./switch_with_empty_body.jsligo
    ...
    PASS, 11, 21, 5, 98, 2, ./switch_with_not_last_default.jsligo
    ...
    PASS, 3, 253, 17, 733, 0, ./unfinished_code02.jsligo
    PASS, 3, 8, 8, 886, 0, ./unfinished_code03.jsligo
    ...
    PASS, 3, 20, 6, 116, 0, ./unfinished_code09.jsligo
    ...
    PASS, 6, 65, 5, 121, 1, ./using_then_in_if_expr.jsligo
    PASS, 15, 112, 12, 201, 0, ./var_kw_instead_of_let_kw.jsligo |}]
