let%expect_test "error_recovery_simple_jsligo" =
  ...
  [%expect
    ...
    PASS, 4, 95, 21, 189, 3, ./extra_eq_in_func_decl.jsligo
    ...
    PASS, 5, 89, 29, 63, 6, ./missing_comma_in_arguments.jsligo
    PASS, 4, 26, 12, 22, 2, ./missing_comma_in_list_pat.jsligo
    PASS, 4, 32, 24, 341, 1, ./missing_comma_in_record_decl.jsligo
    PASS, 6, 105, 51, 85, 11, ./missing_comma_in_tuple_pat.jsligo
    PASS, 13, 219, 1, 136, 0, ./missing_curly_bracketR_in_the_nested_namespace.jsligo
    ...
    PASS, 4, 95, 21, 189, 2, ./missing_name_of_argument.jsligo
    PASS, 16, 140, 12, 260, 2, ./missing_namespace_kw_in_namespace_decl.jsligo
    PASS, 2, 2, 2, 8, 0, ./missing_namespace_name.jsligo
    PASS, 16, 133, 1, 254, 1, ./missing_open_curly_bracket_in_namespace_decl.jsligo
    ...
    PASS, 11, 21, 5, 108, 2, ./switch_with_not_last_default.jsligo
    ...
    PASS, 3, 269, 17, 747, 0, ./unfinished_code02.jsligo
    PASS, 3, 8, 8, 900, 0, ./unfinished_code03.jsligo
    ...
    PASS, 3, 20, 6, 126, 0, ./unfinished_code09.jsligo
    ...
    PASS, 6, 65, 5, 131, 1, ./using_then_in_if_expr.jsligo
    PASS, 15, 112, 12, 211, 0, ./var_kw_instead_of_let_kw.jsligo |}]
