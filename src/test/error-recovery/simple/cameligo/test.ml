let%expect_test "error_recovery_simple_cameligo" =
  ...
  [%expect
    ...
    PASS, 8, 3, 3, 118, 0, ./unfinished_code11.mligo
    PASS, 4, 7, 5, 184, 0, ./unfinished_code12.mligo
    PASS, 46, 284, 24, 179, 1, ./unfinished_code13.mligo
