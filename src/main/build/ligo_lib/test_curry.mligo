...
module Test = struct
  ...
  let transfer (a : address) (s : michelson_program) (t : tez) : test_exec_result = [%ext ("TEST_EXTERNAL_CALL_TO_ADDRESS", a, s, t)]
  let transfer_exn (a : address) (s : michelson_program) (t : tez) : nat = [%ext ("TEST_EXTERNAL_CALL_TO_ADDRESS_EXN", a, s, t)]
