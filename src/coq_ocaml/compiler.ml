...
| u :: us0 ->
  (match u with
   | Drop ->
     (Tezos_micheline.Micheline.Prim (nil, "DIG", ((Tezos_micheline.Micheline.Int
       (nil, (Z.of_nat n))) :: []), [])) :: ((Tezos_micheline.Micheline.Seq (nil,
...
| S n0 ->
  (match n0 with
   | O -> []
   | S _ ->
     (Tezos_micheline.Micheline.Prim (nil, "PAIR", ((Tezos_micheline.Micheline.Int
       (nil, (Z.of_nat n))) :: []), [])) :: [])
...
| S n0 ->
  (match n0 with
   | O -> []
   | S _ ->
     (Tezos_micheline.Micheline.Prim (nil, "UNPAIR", ((Tezos_micheline.Micheline.Int
       (nil, (Z.of_nat n))) :: []), [])) :: [])
...
let coq_GET nil i n =
  let i0 =
    if PeanoNat.Nat.eqb (S i) n then mul (S (S O)) i else add (mul (S (S O)) i) (S O)
  in
...
let coq_UPDATE nil i n =
  let i0 =
    if PeanoNat.Nat.eqb (S i) n then mul (S (S O)) i else add (mul (S (S O)) i) (S O)
  in
  (Tezos_micheline.Micheline.Prim (nil, "UPDATE", ((Tezos_micheline.Micheline.Int
  (nil, (Z.of_nat i0))) :: []), [])) :: []
...
(** val compile_expr :
    ...
    Tezos_micheline.Micheline.node) -> ('a1, string) Tezos_micheline.Micheline.node
    list -> splitting -> ('a1, 'a2, 'a3) expr -> ('a1, string)
...
let compile_expr nil op_code lit_type lit_value =
  ...
  | E_lam (_, e0, b) ->
    ...
    (match env with
     | [] ->
       (Tezos_micheline.Micheline.Seq (nil,
         (compile_splitting nil outer))) :: ((Tezos_micheline.Micheline.Prim (nil,
     ...
     | _ :: _ ->
       ...
       (coq_PAIR nil (length env)))) :: ((Tezos_micheline.Micheline.Prim (nil,
       "LAMBDA", ((Tezos_micheline.Micheline.Prim (nil, "pair",
       ((comb nil env) :: (a :: [])), [])) :: (b :: ((Tezos_micheline.Micheline.Seq
       (nil, body)) :: []))), [])) :: ((Tezos_micheline.Micheline.Prim (nil, "SWAP",
  ...
  | E_if_left (_, e0) ->
    ...
    let (e1, e2) = p in
    (Tezos_micheline.Micheline.Seq (nil, e1)) :: ((Tezos_micheline.Micheline.Prim
    (nil, "IF_LEFT", ((Tezos_micheline.Micheline.Seq (nil,
    e2)) :: ((Tezos_micheline.Micheline.Seq (nil, e3)) :: [])), [])) :: [])
  | E_if_bool (_, e0) ->
    let (p, e3) = compile_cond0 env outer e0 in
    let (e1, e2) = p in
    (Tezos_micheline.Micheline.Seq (nil, e1)) :: ((Tezos_micheline.Micheline.Prim
    (nil, "IF", ((Tezos_micheline.Micheline.Seq (nil,
    e2)) :: ((Tezos_micheline.Micheline.Seq (nil, e3)) :: [])), [])) :: [])
  | E_if_none (_, e0) ->
    let (p, e3) = compile_cond0 env outer e0 in
    let (e1, e2) = p in
    (Tezos_micheline.Micheline.Seq (nil, e1)) :: ((Tezos_micheline.Micheline.Prim
    (nil, "IF_NONE", ((Tezos_micheline.Micheline.Seq (nil,
    e2)) :: ((Tezos_micheline.Micheline.Seq (nil, e3)) :: [])), [])) :: [])
  | E_if_cons (_, e0) ->
    let (p, e3) = compile_cond0 env outer e0 in
    let (e1, e2) = p in
    (Tezos_micheline.Micheline.Seq (nil, e1)) :: ((Tezos_micheline.Micheline.Prim
    (nil, "IF_CONS", ((Tezos_micheline.Micheline.Seq (nil,
    e2)) :: ((Tezos_micheline.Micheline.Seq (nil, e3)) :: [])), [])) :: [])
  ...
  | E_loop_left (_, inner, e1, b, e2) ->
    ...
    (Tezos_micheline.Micheline.Seq (nil,
    (compile_expr0 env2 outer0 e2))) :: ((Tezos_micheline.Micheline.Prim (nil,
    "LEFT", (b :: []), [])) :: ((Tezos_micheline.Micheline.Prim (nil, "LOOP_LEFT",
    ((Tezos_micheline.Micheline.Seq (nil,
    (compile_binds0 env1 (keep_rights (left_usages inner1))
      (filter_keeps (right_usages outer0)) e1))) :: []),
    [])) :: ((Tezos_micheline.Micheline.Seq (nil,
  ...
  | E_fold_right (_, elem, inner1, e1, inner2, e2, e3) ->
    ...
    [])) :: []))))) :: ((Tezos_micheline.Micheline.Prim (nil, "ITER",
    ((Tezos_micheline.Micheline.Seq (nil, ((Tezos_micheline.Micheline.Prim (nil,
    "PAIR", [], [])) :: ((Tezos_micheline.Micheline.Seq (nil,
    (compile_binds0 env3 (keep_rights (left_usages inner5))
      (filter_keeps (right_usages inner4)) e3))) :: [])))) :: []),
    [])) :: ((Tezos_micheline.Micheline.Seq (nil,
    (compile_usages nil (Keep :: (right_usages inner5))))) :: []))))
  ...
  | E_raw_michelson (_, a, b, code) ->
    (Tezos_micheline.Micheline.Prim (nil, "PUSH", ((Tezos_micheline.Micheline.Prim
      (nil, "lambda", (a :: (b :: [])), [])) :: ((Tezos_micheline.Micheline.Seq
      (nil, code)) :: [])), [])) :: []
  | E_constantize (_, e0) ->
    (Tezos_micheline.Micheline.Prim (nil, "constant",
      ((Tezos_micheline.Micheline.Seq (nil, (compile_expr0 env outer e0))) :: []),
      [])) :: []
...
(** val compile_args :
    ...
    Tezos_micheline.Micheline.node) -> ('a3 -> ('a1, string)
    Tezos_micheline.Micheline.node) -> ('a1, string) Tezos_micheline.Micheline.node
    list -> splitting -> ('a1, 'a2, 'a3) args -> ('a1, string)
    Tezos_micheline.Micheline.node list **)
...
(** val compile_binds :
    ...
    Tezos_micheline.Micheline.node) -> ('a3 -> ('a1, string)
    Tezos_micheline.Micheline.node) -> ('a1, string) Tezos_micheline.Micheline.node
    list -> splitting -> usage list -> ('a1, 'a2, 'a3) binds -> ('a1, string)
    Tezos_micheline.Micheline.node list **)
...
(** val compile_cond :
    ...
    Tezos_micheline.Micheline.node) -> ('a3 -> ('a1, string)
    Tezos_micheline.Micheline.node) -> ('a1, string) Tezos_micheline.Micheline.node
    list -> splitting -> ('a1, 'a2, 'a3) cond -> (('a1, string)
