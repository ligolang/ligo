  ...
  return (
    <TableCard title="Account" tableScroll>
        ...
        <TableCardRow
          ...
          right={
            <UncontrolledDropdown>
              <DropdownToggle
                caret
                className="badge badge-pill d-flex align-items-center"
                color="info"
              >
                {erc20Tokens.length}
              </DropdownToggle>
                ...
                {erc20Tokens.map((t) => {
                  ...
                  return (
                    <DropdownItem
                      ...
                      onClick={() => history.push(`/account/${t.address}`)}
                    >
      ...
      {account.nonce !== undefined && (
        <TableCardRow name="Nonce" icon="fas fa-hashtag" badge={account.nonce} />
      )}
    </TableCard>
  );
}
