...
You can get the rolling release [here](https://gitlab.com/ligolang/ligo/-/jobs/3508308449/artifacts/raw/ligo), make it executable, and you are done!

```zsh
wget https://gitlab.com/ligolang/ligo/-/jobs/3508308449/artifacts/raw/ligo
chmod +x ./ligo
```
...
If you've [installed 🐳 Docker](https://docs.docker.com/install/), you can run the latest [LIGO release 0.58.0](./changelog.md):
