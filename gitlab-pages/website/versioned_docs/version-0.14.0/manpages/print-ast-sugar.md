...
ligo-print-ast-sugar - Subcommand: Print the AST. Warning: Intended for
development of LIGO and can break at any time.

### SYNOPSIS

**ligo print-ast-sugar** \[*OPTION*\]\... *SOURCE_FILE*

### DESCRIPTION

This sub-command prints the source file in the AST stage, after sugaring
step is applied.
